...
ADD https://download.geonames.org/export/dump/BE.zip \
...
ADD https://download.geonames.org/export/dump/alternatenames/BE.zip \
...
RUN mkdir -p /data/geonames /data/alternateNames && \
    for COUNTRY in BE BG CH CY CZ DE DK EE ES FI FR GB GR HU IT LI LT LU LV ME MK MT NL NO PL PT RO RS RU SE SI SK SL SM TR UA VA; do \
